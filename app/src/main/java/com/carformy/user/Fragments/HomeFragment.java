package com.carformy.user.Fragments;
/**
 * @Developer android
 * @Company android
 **/
...
import com.carformy.user.CarForMyUserApplication;
import com.carformy.user.Activities.CustomGooglePlacesSearch;
import com.carformy.user.Activities.HistoryActivity;
import com.carformy.user.Activities.Payment;
import com.carformy.user.Activities.ShowProfile;
...
import com.carformy.user.Helper.ConnectionHelper;
import com.carformy.user.Helper.CustomDialog;
import com.carformy.user.Helper.DataParser;
import com.carformy.user.Helper.SharedHelper;
import com.carformy.user.Helper.URLHelper;
import com.carformy.user.Models.CardInfo;
import com.carformy.user.Models.Driver;
import com.carformy.user.Models.PlacePredictions;
import com.carformy.user.R;
import com.carformy.user.Retrofit.ApiInterface;
import com.carformy.user.Retrofit.ResponseListener;
import com.carformy.user.Retrofit.RetrofitClient;
import com.carformy.user.Utils.MapAnimator;
import com.carformy.user.Utils.MyBoldTextView;
import com.carformy.user.Utils.MyButton;
import com.carformy.user.Utils.MyTextView;
import com.carformy.user.Utils.Utilities;
...
import static com.carformy.user.CarForMyUserApplication.trimMessage;
...
//                            frmSource.setText(source_address);
    ...
    public void getServiceList() {
        ...
        try {
            ...
            CarForMyUserApplication.getInstance().addToRequestQueue(jsonArrayRequest);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void getApproximateFare() {
        try {
            ...
            CarForMyUserApplication.getInstance().addToRequestQueue(jsonObjectRequest);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
...
//                            }
    ...
    public void sendRequest() {
        ...
        CarForMyUserApplication.getInstance().cancelRequestInQueue("send_request");
