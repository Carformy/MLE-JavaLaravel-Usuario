...
public class CarForMyUserApplication extends Application {

    public static final String TAG = CarForMyUserApplication.class
            .getSimpleName();

    private RequestQueue mRequestQueue;
    private ImageLoader mImageLoader;

    private static CarForMyUserApplication mInstance;
    ...
    public static synchronized CarForMyUserApplication getInstance() {
        return mInstance;
    }
